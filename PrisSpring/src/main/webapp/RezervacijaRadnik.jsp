...
<body>
	...
	<div class="bod">
	<span class="tekstdva">Prodaja karte za predstavu ${izvodjenje.predstava.naziv }, u sali ${izvodjenje.sala.naziv}, za datum ${izvodjenje.datum}:</span><br/>
	<form:form action="/Pris/predstave/sacuvajRezervaciju" method="post" modelAttribute="karta">
		<table>
			...
			<tr><td><span class="tekst">ID radnika:</span></td><td><form:input path="korisnik" class="form-control"/></td></tr>
