...
<body>
	<div class="header">
		...
		<a href="/Pris/predstave/getPredstaveZaProdaju" class="hdr-dugme"><span>Prodaja</span></a>
	</div>
	<div class="bod">
		...
		<table>
			<c:forEach items="${predstave}" var="p">
				<tr>
					...
					<td><a href="/Pris/predstave/nadjiPredstavuZaProdaju?idPredstave=${p.idpredstava}" class="btnn" style="--clr:#00ccff;"><span>Prodaj kartu</span></a></td>
				</tr>
			</c:forEach>
		</table>
	</c:if>
